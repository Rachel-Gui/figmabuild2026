...
export const ExploreView = () => {
  return (
    <motion.div 
      ...
      className="h-full min-h-0 w-full overflow-y-auto bg-[#fcfbf9] border-[3px] border-[#4E3D2E] rounded-[32px] p-8 flex flex-col items-center justify-center relative text-[#4E3D2E]"
    >
