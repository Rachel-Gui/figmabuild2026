...
export const ExploreView = () => {
  return (
    <motion.div 
      ...
      className="h-full w-full bg-[#fcfbf9] border-[3px] border-[#4E3D2E] rounded-[40px] p-8 shadow-[6px_6px_0px_0px_rgba(78,61,46,1)] flex flex-col items-center justify-center relative overflow-hidden text-[#4E3D2E]"
    >
